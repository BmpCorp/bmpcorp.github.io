...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__module_nav__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__module_slider__ = __webpack_require__(6);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_jquery__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_jquery___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2_jquery__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_jquery_touchswipe__ = __webpack_require__(8);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_jquery_touchswipe___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3_jquery_touchswipe__);
...
__WEBPACK_IMPORTED_MODULE_2_jquery___default()(document).ready(function () {
    // Обрабатываем включаемые области.
    var includes = __WEBPACK_IMPORTED_MODULE_2_jquery___default()(".include");
    var includesProcessed = 0;

    if (includes.length > 0) {
        includes.each(function (index, el) {
            var _this = __WEBPACK_IMPORTED_MODULE_2_jquery___default()(this);
            __WEBPACK_IMPORTED_MODULE_2_jquery___default.a.ajax({
                url: '/html/include/' + _this.attr("id") + '.html',
                type: 'GET',
                dataType: 'html'
            }).done(function (result) {
                __WEBPACK_IMPORTED_MODULE_2_jquery___default()(result).insertAfter(_this);
                _this.remove();
                includesProcessed++;
                if (includesProcessed === includes.length) {
                    // Когда все области обработаны, выполняем остальные действия.
                    init();
                }
            });
        });
    } else {
        // Включаемых областей на странице нет, активируем остальные скрипты сразу.
        init();
    }
});

function init() {
    __WEBPACK_IMPORTED_MODULE_0__module_nav__["a" /* default */].init();
    __WEBPACK_IMPORTED_MODULE_1__module_slider__["a" /* default */].init();
};
        ...
        this.init = function () {
            ...
            if (menu) {
                ...
                submenuTitles.forEach(function (submenuTitle) {
                    submenuTitle.addEventListener("click", _this.submenuClicked);
                });
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_swiper__ = __webpack_require__(9);
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
...
/* harmony default export */ __webpack_exports__["a"] = (new (function () {
    function _class2() {
        ...
        this.init = function () {
            ...
            var resultsSlider = document.querySelector("." + _this.resultsSliderClass);
            if (resultsSlider) {
                new __WEBPACK_IMPORTED_MODULE_0_swiper__["a" /* default */]("." + _this.resultsSliderClass, {
                    spaceBetween: 24,
                    loop: true,
                    pagination: {
            ...
            var articleSlider = document.querySelector("." + _this.articleGalleryClass);
            if (articleSlider) {
                var thumbs = new __WEBPACK_IMPORTED_MODULE_0_swiper__["a" /* default */]("." + _this.articleThumbsClass, {
                    spaceBetween: 16,
                    slidesPerView: 6,
                    freeMode: true,
 ...
 *
 */
!function(factory){"function"=="function"&&__webpack_require__(2)&&__webpack_require__(2).jQuery?!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(0)], __WEBPACK_AMD_DEFINE_FACTORY__ = (factory),
